...
class BelongsToMany extends Relation
{
     ...
     * 构造函数
     * @access public
     * @param Model  $parent     上级文件对象
     * @param string $model      文件名
     * @param string $table      中间表名
     * @param string $foreignKey 关联文件外键
     * @param string $localKey   当前文件关联键
     */
     ...
     * @access public
     * @param string $foreignKey 关联文件关联键
     * @param string $localKey   当前文件关联键
     ...
     * 保存（新增）当前关联数据对象
     * @access public
     * @param mixed $data  数据 可以使用数组 关联文件对象 和 关联对象的主键
     ...
     * 附加关联的一个中间表数据
     * @access public
     * @param mixed $data  数据 可以使用数组、关联文件对象 或者 关联对象的主键
     * @param array $pivot 中间表额外数据
     * @return array|Pivot
     * @throws Exception
     */
