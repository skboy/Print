...
function __parse_navigationa333f673dd95845fee1c67509a398f30($menus,$level=1){
$_parse_navigation_func_name = '__parse_navigationa333f673dd95845fee1c67509a398f30';
...
if(''==''): ?>
    <?php echo __parse_navigationa333f673dd95845fee1c67509a398f30($menus); else: ?>
    < id="main-navigation" class="nav navbar-nav navbar-nav-custom">
        <?php echo __parse_navigationa333f673dd95845fee1c67509a398f30($menus); ?>
    </>
<?php endif; ?>
...
<div id="footer">
    <?php 
    \think\Hook::listen('footer_start',$temp5b4422f10bbea,null,false);
 ?>
    <div class="links">
        <?php
