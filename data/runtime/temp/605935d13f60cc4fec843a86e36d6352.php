...
<script src="/static/js/wind.js"></script>
    ...
    <?php 
    \think\Hook::listen('before_head_end',$temp5be4fcdf539b2,null,false);
 ?>
</head>
...
function __parse_navigation2b0318f5c8c98c4873f0cdfd66599834($menus,$level=1){
$_parse_navigation_func_name = '__parse_navigation2b0318f5c8c98c4873f0cdfd66599834';
...
if(''==''): ?>
    <?php echo __parse_navigation2b0318f5c8c98c4873f0cdfd66599834($menus); else: ?>
    < id="main-navigation" class="nav navbar-nav navbar-nav-custom">
        <?php echo __parse_navigation2b0318f5c8c98c4873f0cdfd66599834($menus); ?>
    </>
<?php endif; ?>
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            <a href="<?php echo cmf_get_image_preview_url($vo['avatar']); ?>">
            ...
            <p class="text-center">文件：<?php echo $vo['title']; ?></p>
            <p class="text-center">作者：<?php echo $vo['user']['user_nickname']; ?></p>
            <p class="text-center"><a href="<?php echo cmf_get_file_download_url($vo['model']); ?>">下载</a></p>
        </div>
        <?php endforeach; endif; else: echo "" ;endif; ?>
    </div>

     <ul class="pagination" style="display: block;float: right;"><?php echo (isset($page) && ($page !== '')?$page:''); ?></ul>
...
<?php 
    \think\Hook::listen('before_body_end',$temp5be4fcdf539c2,null,false);
 ?>
</body>
</html>
