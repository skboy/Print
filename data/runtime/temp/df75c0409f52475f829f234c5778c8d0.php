...
function __parse_navigationfb31dfbadf3beb5a4ebe4c9517d79287($menus,$level=1){
$_parse_navigation_func_name = '__parse_navigationfb31dfbadf3beb5a4ebe4c9517d79287';
...
if(''==''): ?>
    <?php echo __parse_navigationfb31dfbadf3beb5a4ebe4c9517d79287($menus); else: ?>
    < id="main-navigation" class="nav navbar-nav navbar-nav-custom">
        <?php echo __parse_navigationfb31dfbadf3beb5a4ebe4c9517d79287($menus); ?>
    </>
<?php endif; ?>
...
<div id="footer">
    <?php 
    \think\Hook::listen('footer_start',$temp5b4422f64ad2f,null,false);
 ?>
    <div class="links">
        <?php
