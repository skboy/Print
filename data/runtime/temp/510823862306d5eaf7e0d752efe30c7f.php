...
function __parse_navigation46a10b970ddbc3cb799f39e9393ad6eb($menus,$level=1){
$_parse_navigation_func_name = '__parse_navigation46a10b970ddbc3cb799f39e9393ad6eb';
...
if(''==''): ?>
    <?php echo __parse_navigation46a10b970ddbc3cb799f39e9393ad6eb($menus); else: ?>
    < id="main-navigation" class="nav navbar-nav navbar-nav-custom">
        <?php echo __parse_navigation46a10b970ddbc3cb799f39e9393ad6eb($menus); ?>
    </>
<?php endif; ?>
...
<div id="footer">
    <?php 
    \think\Hook::listen('footer_start',$temp5b4422f2aab35,null,false);
 ?>
    <div class="links">
        <?php
