...
function __parse_navigation686fb897a7b1e2720263bc5bdb9f1c99($menus,$level=1){
$_parse_navigation_func_name = '__parse_navigation686fb897a7b1e2720263bc5bdb9f1c99';
...
if(''==''): ?>
    <?php echo __parse_navigation686fb897a7b1e2720263bc5bdb9f1c99($menus); else: ?>
    < id="main-navigation" class="nav navbar-nav navbar-nav-custom">
        <?php echo __parse_navigation686fb897a7b1e2720263bc5bdb9f1c99($menus); ?>
    </>
<?php endif; ?>
...
<div id="footer">
    <?php 
    \think\Hook::listen('footer_start',$temp5b4422f5b3369,null,false);
 ?>
    <div class="links">
        <?php
