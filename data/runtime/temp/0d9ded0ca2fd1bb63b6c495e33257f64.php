<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:44:"themes/simpleboot3/user\profile\binding.html";i:1516847130;s:73:"D:\phpStudy\PHPTutorial\WWW\md\public\themes\simpleboot3\public\head.html";i:1516847130;s:77:"D:\phpStudy\PHPTutorial\WWW\md\public\themes\simpleboot3\public\function.html";i:1516847130;s:72:"D:\phpStudy\PHPTutorial\WWW\md\public\themes\simpleboot3\public\nav.html";i:1516847130;s:76:"D:\phpStudy\PHPTutorial\WWW\md\public\themes\simpleboot3\public\usernav.html";i:1516847130;s:75:"D:\phpStudy\PHPTutorial\WWW\md\public\themes\simpleboot3\public\footer.html";i:1516847130;s:76:"D:\phpStudy\PHPTutorial\WWW\md\public\themes\simpleboot3\public\scripts.html";i:1516847130;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<title><?php echo $user_login; ?>  - 绑定账号</title>
...
function __parse_navigation9dfb1f78a463c0eef15ddd991cbbe0e4($menus,$level=1){
$_parse_navigation_func_name = '__parse_navigation9dfb1f78a463c0eef15ddd991cbbe0e4';
...
if(''==''): ?>
    <?php echo __parse_navigation9dfb1f78a463c0eef15ddd991cbbe0e4($menus); else: ?>
    < id="main-navigation" class="nav navbar-nav navbar-nav-custom">
        <?php echo __parse_navigation9dfb1f78a463c0eef15ddd991cbbe0e4($menus); ?>
    </>
<?php endif; ?>
							...
							<form class="js-ajax-form" action="<?php echo url('user/Profile/bindingMobile'); ?>" method="post">
								<div class="form-group">
									...
									<div style="position: relative;height: 38px;">
										...
										<a class="btn btn-success js-get-mobile-code" style="width: 180px;float: left;margin-right: 30px" data-wait-msg="[second]后才能再次获取" data-mobile-input="#js-mobile-input" data-url="<?php echo url('user/VerificationCode/send'); ?>">获取手机验证码</a>
								...
								<div class="form-group">
									...
									<div style="position: relative;height: 38px;">
										<input type="text" class="form-control" placeholder="邮箱"id="js-mobile" name="mobile" value="<?php echo $mobile; ?>" disabled>
										<button type="submit" class="btn"style="width: 170px;position: absolute;top:0;right: 0;">已绑定邮箱</button>
									</div>
								</div>
							<?php endif; if(empty($user_email)): ?>
								<form class="js-ajax-form" action="<?php echo url('user/Profile/bindingEmail'); ?>" method="post">
									<div class="form-group">
										...
										<div style="position: relative;height: 38px;">
											...
											<a class="btn btn-success js-get-email-code" style="width: 180px;float: left;margin-right: 30px" data-wait-msg="[second]后才能再次获取" data-email-input="#js-email-input" data-url="<?php echo url('user/VerificationCode/send'); ?>" data-init-second-left="60">获取邮箱验证码</a>
											<button type="submit" class="btn btn-primary js-ajax-submit"style="width: 170px;position: absolute;top:0;right: 0;">验证</button>
										</div>
									</div>
								</form>
								...
								<div class="form-group">
									...
									<div style="position: relative;height: 38px;">
										<input type="text" class="form-control" placeholder="邮箱"id="js-email" name="mobile" value="<?php echo $user_email; ?>" disabled>
										<button type="submit" class="btn"style="width: 170px;position: absolute;top:0;right: 0;">已绑定邮箱</button>
									</div>
								</div>
							<?php endif; ?>
...
<div id="footer">
    <?php 
    \think\Hook::listen('footer_start',$temp5b4422f3c1850,null,false);
 ?>
    <div class="links">
        <?php
