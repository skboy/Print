...
function __parse_navigation3c702605f35ed29afeb933f40e942ca2($menus,$level=1){
$_parse_navigation_func_name = '__parse_navigation3c702605f35ed29afeb933f40e942ca2';
...
if(''==''): ?>
    <?php echo __parse_navigation3c702605f35ed29afeb933f40e942ca2($menus); else: ?>
    < id="main-navigation" class="nav navbar-nav navbar-nav-custom">
        <?php echo __parse_navigation3c702605f35ed29afeb933f40e942ca2($menus); ?>
    </>
<?php endif; ?>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="one">
                        ...
                        <?php if(empty($avatar)): ?>
                            ...
                            <?php else: ?>
                            <img src="<?php echo cmf_get_user_avatar_url($avatar); ?>?t=<?php echo time(); ?>" class="headicon" width="128"/>
                        <?php endif; ?>
...
<div id="footer">
    <?php 
    \think\Hook::listen('footer_start',$temp5b4422f327301,null,false);
 ?>
    <div class="links">
        <?php
...
<script type="text/javascript">
    function update_avatar() {
        ...
        $.post("<?php echo url('Profile/avatarUpdate'); ?>", area, function (data) {
            if (data.code == 1) {
                reloadPage(window);
            }
    ...
    function avatar_upload(obj) {
        ...
        Wind.use("ajaxfileupload", "jcrop", "noty", function () {
            $.ajaxFileUpload({
                url: "<?php echo url('Profile/avatarUpload'); ?>",
                secureuri: false,
